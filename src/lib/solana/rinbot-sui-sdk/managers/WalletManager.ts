...
import { determineFormat, WalletEncryption } from "./WalletManager.utils";
...
export class WalletManagerSingleton implements IWalletManager {
  ...
  public static generateWallet() {
   ...
   /**
   * Generates a new Ed25519 key pair for a wallet, consisting of a public key and a private key (encrypted with AES-256-CBC).
   * @return {{ publicKey: string, encryptedPrivateKey: string }} An object with the public, encrypted private key.
   */
  public static async generateEncryptedWallet() {
